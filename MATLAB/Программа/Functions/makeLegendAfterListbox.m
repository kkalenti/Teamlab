        ...
        case 1
            ...
            if(chPoi == 0 && chNoize == 0 && chStrob == 0)
                legend([realPlot(realIndex).ch1.coordinate,realPlot(realIndex).ch2.coordinate,...
                    ...
                    hypoPlot(voiIndex).ch1.coordinate,hypoPlot(voiIndex).ch2.coordinate,...
                    hypoPlot(voiIndex).ch3.coordinate]);
            end
        ...
        case 2
            legend([realPlot(realIndex).ch1.speed,realPlot(realIndex).ch2.speed,...
                realPlot(realIndex).ch3.speed,...
                 ...
                 hypoPlot(voiIndex).ch1.speed,hypoPlot(voiIndex).ch2.speed,...
                 hypoPlot(voiIndex).ch3.speed]);
        case 3
            legend([realPlot(realIndex).ch1.acceleration,realPlot(realIndex).ch2.acceleration,...
                ...
                hypoPlot(voiIndex).ch1.acceleration,hypoPlot(voiIndex).ch2.acceleration,...
                hypoPlot(voiIndex).ch3.acceleration]);     
    end